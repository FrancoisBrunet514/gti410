...
public class HSVConverter {
	...
	/**
	 * Ceci est le constructeur de la couleur en RGB.
	 * Il fait aussi l'appel pour convertir en HSV.
	 * 
	 * @param r: la valeur rouge
	 * @param g: la valeur vert
	 * @param b: la valeur bleu
	 */
	public HSVConverter(int r, int g, int b) {
		this.r = r;
		this.g = g;
		this.b = b;
	...
	/**
	 * Ceci est le constructeur de la couleur en HSV.
	 * Il fait aussi l'appel pour convertir en RGB.
	 * 
	 * @param h: la valeur pour la teinte
	 * @param s: la valeur pour la saturation
	 * @param v: la valeur pour l'intensité
	 */
	public HSVConverter(double h, double s, double v) {
		this.h = h;
		this.s = s;
		this.v = v;
